              ...
              <Nav className="ml-auto" navbar>
                <div style={{ marginLeft: "20px" }}>
                  <UncontrolledDropdown nav inNavbar>
                    ...
                    <DropdownMenu right>
                      <DropdownItem>FOYER</DropdownItem>
                      <DropdownItem>LIVING</DropdownItem>
                      <DropdownItem>DINING</DropdownItem>
                      <DropdownItem>MY CORNER</DropdownItem>
                    </DropdownMenu>
                  </UncontrolledDropdown>
                </div>
                ...
                <div style={{ marginLeft: "20px" }}>
                  <NavItem>
                    <UncontrolledDropdown nav inNavbar>
                      ...
                      <DropdownMenu right>
                        <DropdownItem>FOOTREST</DropdownItem>
                        <DropdownItem>COFFEE TABLES</DropdownItem>
                      </DropdownMenu>
                    </UncontrolledDropdown>
                  </NavItem>
                </div>
